...
#ifndef ULTRASERVER_CONFIG_H
#define ULTRASERVER_CONFIG_H
    ...
    public:
        ...
        std::string toString() override {
            try {
                ...
                ULTRA_LOG_ERROR(ULTRA_LOG_ROOT()) << "ConfigVar::toString exception "
        ...
        bool fromString(const std::string &val) override {
            try {
                ...
                ULTRA_LOG_ERROR(ULTRA_LOG_ROOT()) << "ConfigVar::fromString exception "
    ...
    public:
        ...
        static typename ConfigVar<T>::ptr Lookup(const std::string &name,
            ...
            if (it != GetDatas().end()) {
                ...
                if (tmp) {
                    ULTRA_LOG_INFO(ULTRA_LOG_ROOT()) << "Lookup name=" << name << " exists";
                    return tmp;
                } else {
                    ULTRA_LOG_ERROR(ULTRA_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
            ...
            if (name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678") != std::string::npos) {
                ULTRA_LOG_ERROR(ULTRA_LOG_ROOT()) << "Lookup name invalid " << name;
