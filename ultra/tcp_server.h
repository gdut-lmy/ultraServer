...
#ifndef ULTRASERVER_TCP_SERVER_H
#define ULTRASERVER_TCP_SERVER_H
 ...
 */
    ...
    public:
         ...
         */
        TcpServer(ultra::IOManager *io_woker = ultra::IOManager::GetThis(),
         ...
         * @return 返回是否绑定成功
         */
        virtual bool bind(ultra::Address::ptr addr);
...
#endif //ULTRASERVER_TCP_SERVER_H
