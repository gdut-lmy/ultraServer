...
#ifndef ULTRASERVER_SOCKET_H
#define ULTRASERVER_SOCKET_H
 ...
 */
    ...
    public:
         ...
         * @param[in] address 地址
         */
        static Socket::ptr CreateTCP(ultra::Address::ptr address);

        /**
         * @brief 创建UDP Socket(满足地址类型)
         * @param[in] address 地址
         */
        static Socket::ptr CreateUDP(ultra::Address::ptr address);
